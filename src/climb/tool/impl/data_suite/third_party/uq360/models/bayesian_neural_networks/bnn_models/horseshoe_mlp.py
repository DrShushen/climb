...
import numpy as np
import torch
from climb.tool.impl.data_suite.third_party.uq360.models.bayesian_neural_networks.layers import (
    BayesianLinearLayer,
    HorseshoeLayer,
    RegularizedHorseshoeLayer,
)
...
class HshoeRegressionNet(HshoeBNN, ABC):
    ...
    def __init__(
        ...
        super(HshoeRegressionNet, self).__init__(
            ip_dim=ip_dim,
            op_dim=op_dim,
            num_nodes=num_nodes,
...
class HshoeClassificationNet(HshoeBNN, ABC):
    ...
    def __init__(
        ...
        super(HshoeClassificationNet, self).__init__(
            ip_dim=ip_dim,
            op_dim=op_dim,
            num_nodes=num_nodes,
            activation_type=activation_type,
