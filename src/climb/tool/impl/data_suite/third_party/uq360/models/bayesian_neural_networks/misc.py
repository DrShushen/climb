import numpy as np
import torch
from climb.tool.impl.data_suite.third_party.uq360.models.noise_models.homoscedastic_noise_models import GaussianNoiseFixedPrecision


def compute_test_ll(y_test, y_pred_samples, std_y=1.0):
    """
