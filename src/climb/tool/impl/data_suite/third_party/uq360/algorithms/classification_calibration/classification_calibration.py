...
from climb.tool.impl.data_suite.third_party.uq360.utils.misc import DummySklearnEstimator
...
class ClassificationCalibration(PostHocUQ):
    ...
    def fit(self, X, y):
        ...
        self.calib_model = CalibratedClassifierCV(base_estimator=self.base_model, cv="prefit", method=self.method)
