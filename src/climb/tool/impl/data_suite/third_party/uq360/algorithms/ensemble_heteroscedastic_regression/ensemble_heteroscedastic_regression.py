...
from climb.tool.impl.data_suite.third_party.uq360.algorithms.heteroscedastic_regression import HeteroscedasticRegression
...
class EnsembleHeteroscedasticRegression(BuiltinUQ):
    ...
    def predict(self, X, return_dists=False):
        ...
        dataset_loader = DataLoader(X, batch_size=self.config["model_kwargs"]["config"]["batch_size"])
