...
class MEPSDataset:
    ...
    def __init__(self, custom_preprocessing=default_preprocessing, dirpath=None):
        ...
        try:
            ...
            print("\n\t{}\n".format(os.path.abspath(os.path.join(os.path.abspath(__file__), "../data", "meps_data"))))
            print(
                "See :file:`uq360/data/meps_data/README.md` for more details on the dataset and instructions "
