...
class BankMarketingDataset:
    ...
    def __init__(self, custom_preprocessing=default_preprocessing, dirpath=None):
        ...
        try:
            ...
            print(
                "\n\t{}\n".format(os.path.abspath(os.path.join(os.path.abspath(__file__), "../data", "banking_data")))
            )
            print(
                "See :file:`uq360/data/banking_data/README.md` for more details on the dataset and instructions "
