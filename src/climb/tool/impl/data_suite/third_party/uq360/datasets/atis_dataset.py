...
class AtisDataset:
    ...
    def __init__(self, custom_preprocessing=default_preprocessing, dirpath=None):
        ...
        try:
            ...
            print(
                "\n\t{}\n".format(os.path.abspath(os.path.join(os.path.abspath(__file__), "../data", "atis_text_data")))
            )
            print(
                "See :file:`uq360/data/atis_text_data/README.md` for more details on the dataset and instructions "
