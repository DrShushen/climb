...
import numpy as np
from climb.tool.impl.data_suite.third_party.uq360.utils.hpo_search import CustomRandomSearch
...
from climb.tool.impl.data_suite.third_party.uq360.utils.transformers.feature_transformer import FeatureTransformer
...
class SVCTransformer(FeatureTransformer):
    ...
    def __init__(self):
        ...
        self.model_params = {"random_state": self.random_seed, "probability": True, "verbose": 0}
