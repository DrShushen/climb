...
import numpy as np
import scipy
from climb.tool.impl.data_suite.third_party.copulas import EPSILON, get_qualified_name
from climb.tool.impl.data_suite.third_party.copulas.bivariate.base import Bivariate
...
class Edge(object):
    ...
    def is_adjacent(self, another_edge):
        ...
        """
        return (
            self.L == another_edge.L or self.L == another_edge.R or self.R == another_edge.L or self.R == another_edge.R
        )
