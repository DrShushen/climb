...
import numpy as np
from climb.tool.impl.data_suite.third_party.copulas import NotFittedError, get_instance, get_qualified_name, store_args
from climb.tool.impl.data_suite.third_party.copulas.univariate.selection import select_univariate
...
class Univariate(object):
    ...
    @store_args
    def __init__(self, candidates=None, parametric=None, bounded=None, random_seed=None, selection_sample_size=None):
