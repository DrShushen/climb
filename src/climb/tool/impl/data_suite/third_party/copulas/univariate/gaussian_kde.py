import numpy as np
from climb.tool.impl.data_suite.third_party.copulas import EPSILON, store_args
from climb.tool.impl.data_suite.third_party.copulas.optimize import bisect, chandrupatla
