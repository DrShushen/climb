...
import numpy as np
from climb.tool.impl.data_suite.third_party.copulas import EPSILON, NotFittedError, random_state
...
class Bivariate(object):
    ...
    def select_copula(cls, X):
        ...
        """
        from climb.tool.impl.data_suite.third_party.copulas.bivariate import select_copula  # noqa
