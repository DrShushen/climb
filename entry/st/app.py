...
st.info(
    (
        f"Please select a page from the sidebar. If this is your first time using :grey-background[{st_common.TITLE}], "
        f"start at the :grey-background[{st_common.PAGE_TITLES['research_management_emoji']}] page."
    ),
    icon=":material/info:",
)
